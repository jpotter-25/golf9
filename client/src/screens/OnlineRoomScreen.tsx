...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#1A2943', padding: 20, justifyContent: 'center' },
  scrollContainer: { flex: 1, backgroundColor: '#1A2943' },
  roomContent: { flexGrow: 1, padding: 20, justifyContent: 'center' },
  title: { color: '#67E0B0', fontSize: 34, fontWeight: '900', textAlign: 'center', marginBottom: 8 },
  rankedTitle: { color: '#F4C95D' },
  subtitle: { color: '#F7FAFC', textAlign: 'center', marginBottom: 18, fontSize: 16 },
  ...
  summaryLabel: { color: '#A9B9CD', fontWeight: '800' },
  summaryValue: { color: '#F7FAFC', fontWeight: '800' },
  rankedBadge: { color: '#F4C95D', fontWeight: '900' },
  potSummary: {
    borderWidth: 1,
  ...
  countdownNumber: { color: '#67E0B0', fontSize: 36, fontWeight: '900', marginTop: 2 },
  input: {
    borderWidth: 1,
    borderColor: '#435C7D',
    borderRadius: 8,
  ...
  avatar: { color: '#67E0B0', fontWeight: '900', width: 34, fontSize: 18, textAlign: 'center' },
  playerInfo: { flex: 1, minWidth: 0 },
  playerName: { color: '#F7FAFC', fontWeight: '800', fontSize: 16 },
  status: { color: '#A9B9CD', fontSize: 12, marginTop: 2 },
  readyDot: { color: '#A9B9CD', fontSize: 11, fontWeight: '900', minWidth: 46, textAlign: 'right' },
  readyDotOn: { color: '#67E0B0' },
  invitePanel: {
    borderWidth: 1,
    borderColor: '#435C7D',
  ...
  inviteTitle: { color: '#F7FAFC', fontWeight: '900', fontSize: 15 },
  inviteLink: { color: '#F4C95D', fontWeight: '900', textDecorationLine: 'underline' },
  ...
  friendAvatarText: { color: '#F7FAFC', fontWeight: '900' },
  inviteButton: {
    minWidth: 68,
    minHeight: 34,
    borderRadius: 8,
  ...
  inviteButtonText: { color: '#1A2943', fontWeight: '900', fontSize: 12 },
  inviteEmpty: { color: '#A9B9CD', fontWeight: '800', paddingVertical: 6 },
  button: { backgroundColor: '#67E0B0', padding: 14, borderRadius: 8, alignItems: 'center', marginTop: 12 },
  actionsStack: {
    gap: 12,
    marginTop: 8,
  },
  ...
  rankedNoticeText: { color: '#F4C95D', textAlign: 'center', fontWeight: '900' },
  disabled: { opacity: 0.45 },
  buttonText: { color: '#1A2943', fontWeight: '900', fontSize: 16 },
  linkButton: { alignItems: 'center', marginTop: 14, padding: 8 },
  link: { color: '#F4C95D', textDecorationLine: 'underline', fontSize: 16 },
});
