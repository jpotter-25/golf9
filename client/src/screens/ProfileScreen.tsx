...
// Purpose: Display basic user information and statistics.  Currently this is
// placeholder content; hook into a backend or state store when available.
...
export default function ProfileScreen({ navigation }: Props) {
  return (
    <View style={styles.container}>
      ...
      {/* Placeholder stats – replace with real user data */}
