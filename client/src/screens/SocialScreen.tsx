...
const styles = StyleSheet.create({
  ...
  title: { color: '#F7FAFC', fontSize: 34, fontWeight: '900' },
  ...
  clubhouseBadgeText: { color: '#F7FAFC', fontWeight: '900', fontSize: 12 },
  clubhouseTitle: { color: '#F7FAFC', fontSize: 18, fontWeight: '900' },
  clubhouseOpen: { color: '#67E0B0', fontWeight: '900', fontSize: 13 },
  section: { marginBottom: 16 },
  sectionTitle: { color: '#F7FAFC', fontSize: 18, fontWeight: '900', marginBottom: 8 },
  playerCard: {
    minHeight: 76,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  avatarOnline: { backgroundColor: '#205E56', borderColor: '#67E0B0' },
  avatarText: { color: '#F7FAFC', fontWeight: '900', fontSize: 18 },
  rowCopy: { flex: 1, minWidth: 0 },
  rowTitle: { color: '#F7FAFC', fontSize: 15, fontWeight: '900' },
  rowMeta: { color: '#A9B9CD', fontSize: 12, fontWeight: '800', marginTop: 3 },
  clubMeta: { color: '#67E0B0', fontSize: 11, fontWeight: '900', marginTop: 3 },
  recentMeta: { color: '#F4C95D', fontSize: 11, fontWeight: '900', marginTop: 3 },
  ...
  smallButtonGhost: { backgroundColor: 'transparent', borderWidth: 1, borderColor: '#67B7FF' },
  smallButtonDanger: { backgroundColor: 'transparent', borderWidth: 1, borderColor: '#FF6B6B' },
  smallButtonText: { color: '#1A2943', fontWeight: '900', fontSize: 12 },
  smallButtonGhostText: { color: '#F7FAFC' },
